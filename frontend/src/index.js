...
function homeNav() {
  ...
  p2.innerText =
    "Help us, Payton and Stephanie! You're our only hope! It is a period of civil war. Rebel spaceships, striking from a hidden base, have won their first victory against the evil Galactic Empire.";
  const p3 = document.createElement('p');
  p3.innerText =
    'During the battle, empire spies managed to steal secret documents of the Rebels’s ultimate weapon, Jabbas Hit List.';
  const p4 = document.createElement('p');
  p4.innerText =
    'Pursued by the Rebel’s sinister agents and the notorious gangster Jabba the Hut, our heros races to the rebel base aboard their starship, custodian of the stolen plans that can save the people and restore freedom to the galaxy….';
  // p2.append(p3)
